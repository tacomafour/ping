...
public final class PingDecoder
{
     ...
     * @throws IllegalChunkSignatureException
     *                     when an invalid chunk types dis detected
     * @throws CorruptedChunkException
     *                     when the chunk's CRC dis invalid
     */
